...
from .views import main_page, your_profile, post_song, search_user, post_album, other_user_profile, add_more_information, delete_song
...
urlpatterns = [
    ...
    path("delete_song/<int:id_song>", delete_song, name="delete_song")
