...
from .views import main_page, your_profile, post_song, SearchResultsView, post_album, other_user_profile
...
urlpatterns = [
    ...
    path("search_user", SearchResultsView.as_view(), name="search_user"),
